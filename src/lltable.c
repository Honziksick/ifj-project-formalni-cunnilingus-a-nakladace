...
const struct LLtable LLtable[LL_TERMINAL_COUNT] = {
    ...
    { T_IFJ,                    {  SYNTAX_ERROR,      SYNTAX_ERROR,      SYNTAX_ERROR,      SYNTAX_ERROR,      SYNTAX_ERROR,      SYNTAX_ERROR,      SYNTAX_ERROR,      SYNTAX_ERROR,      SYNTAX_ERROR,      SYNTAX_ERROR,  STATEMENT_LIST_1,       STATEMENT_7,      SYNTAX_ERROR,      SYNTAX_ERROR,      SYNTAX_ERROR,      SYNTAX_ERROR,      SYNTAX_ERROR,      SYNTAX_ERROR,      SYNTAX_ERROR,      SYNTAX_ERROR,      SYNTAX_ERROR,      SYNTAX_ERROR,      SYNTAX_ERROR,      SYNTAX_ERROR,      SYNTAX_ERROR,      SYNTAX_ERROR } },
