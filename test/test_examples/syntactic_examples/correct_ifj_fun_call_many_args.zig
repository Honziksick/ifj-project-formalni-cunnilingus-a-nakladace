...
pub fn main() void {
    ...
    const assign_the_monster =
        ifj.concat(ifj.string(ten), (ifj.concat(ifj.string(pi), (ifj.concat(ifj.string(var_with_very_long_identifier), ifj.concat(ifj.string(nullable), ifj.string("Please work")))))));
