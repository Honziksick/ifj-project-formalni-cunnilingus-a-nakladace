...
TEST(Table, SymAddItems)
{
    ...
    DString* horseVal = string_init();
    ASSERT_NE(horseVal, nullptr);
    DString* horseVal1 = string_init();
    ASSERT_NE(horseVal1, nullptr);
    DString* horseVal2 = string_init();
    ASSERT_NE(horseVal2, nullptr);
    DString* horseVal3 = string_init();
    ASSERT_NE(horseVal3, nullptr);
    DString* horseVal4 = string_init();
    ASSERT_NE(horseVal4, nullptr);
    DString* horseVal5 = string_init();
    ASSERT_NE(horseVal5, nullptr);
    DString* horseVal6 = string_init();
    ASSERT_NE(horseVal6, nullptr);
    DString* horseVal7 = string_init();
    ASSERT_NE(horseVal7, nullptr);
    DString* horseVal8 = string_init();
    ...
    for(size_t i = 0; i < strlen(strConst); i++) {
        ASSERT_EQ(string_append_char(horseVal, strConst[i]), STRING_SUCCESS);
    }
    // Vložení slova do horseVal1 - horseVal7
    for(size_t i = 0; i < strlen(strConst1); i++) {
        ASSERT_EQ(string_append_char(horseVal1, strConst1[i]), STRING_SUCCESS);
        ASSERT_EQ(string_append_char(horseVal2, strConst2[i]), STRING_SUCCESS);
        ASSERT_EQ(string_append_char(horseVal3, strConst3[i]), STRING_SUCCESS);
        ASSERT_EQ(string_append_char(horseVal4, strConst4[i]), STRING_SUCCESS);
        ASSERT_EQ(string_append_char(horseVal5, strConst5[i]), STRING_SUCCESS);
        ASSERT_EQ(string_append_char(horseVal6, strConst6[i]), STRING_SUCCESS);
        ASSERT_EQ(string_append_char(horseVal7, strConst7[i]), STRING_SUCCESS);
        ASSERT_EQ(string_append_char(horseVal8, strConst8[i]), STRING_SUCCESS);
    }
    ...
    EXPECT_EQ(map->allocatedSize, SIZE);
    EXPECT_EQ(string_compare(map->array[index].key, horseVal), STRING_EQUAL);
    ...
    EXPECT_EQ(map->allocatedSize, SIZE);
    EXPECT_EQ(string_compare(map->array[index].key, horseVal1), STRING_EQUAL);
    ...
    symtable_destroyTable(map);
    string_free(horseVal);
    string_free(horseVal1);
    string_free(horseVal2);
    string_free(horseVal3);
    string_free(horseVal4);
    string_free(horseVal5);
    string_free(horseVal6);
    string_free(horseVal7);
    string_free(horseVal8);
}
...
TEST(Table, ItemData) {
    ...
    ASSERT_EQ(string_compare(item1->key, horseVal), STRING_EQUAL);
...
TEST(Table, FunctionData) {
    ...
    for(size_t k = 0; k < strlen(strConst); k++) {
        ASSERT_EQ(string_append_char(horseVal, strConst[k]), STRING_SUCCESS);
    }
    ...
    ASSERT_EQ(string_compare_const_str(foundData->params[0].id, "p"), STRING_EQUAL);
    ASSERT_EQ(foundData->params[0].type, SYMTABLE_TYPE_INT);
    ASSERT_EQ(string_compare_const_str(foundData->params[1].id, "l"), STRING_EQUAL);
